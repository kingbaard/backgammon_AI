...
def grid_search_maskable(env_fn, hyperparams, steps=10_000, num_eval_episodes=20, **env_kwargs):
...
def grid_searc_maskable(env_fn, hyperparams, steps=10_000, num_eval_episodes=20, **env_kwargs):
    # Unpack hyperparameters
    learning_rates = hyperparams['learning_rate']
    gammas = hyperparams['gamma']
    clip_ranges = hyperparams['clip_range']
...
if __name__ == '__main__':
    ...
    def run_grid_search(env_type):
        ...
        results = grid_search(env_fn, hyperparams, steps=5_000, num_eval_episodes=20, **{})
